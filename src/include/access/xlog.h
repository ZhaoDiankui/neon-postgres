...
extern void SetLastWrittenLSNForBlock(XLogRecPtr lsn, RelFileLocator rlocator, ForkNumber forknum, BlockNumber blkno);
extern void SetLastWrittenLSNForBlockRange(XLogRecPtr lsn, RelFileLocator rlocator, ForkNumber forknum, BlockNumber from, BlockNumber n_blocks);
extern void SetLastWrittenLSNForDatabase(XLogRecPtr lsn);
extern void SetLastWrittenLSNForRelation(XLogRecPtr lsn, RelFileLocator rlocator, ForkNumber forknum);
extern XLogRecPtr GetLastWrittenLSN(RelFileLocator rlocator, ForkNumber forknum, BlockNumber blkno);
